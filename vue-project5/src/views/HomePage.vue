...
export default{
  data() {
    return {
      src: 'src/assets/video/local-video.mp4',
      type: 'video/mp4',
      width: 450
    }
  },
...
<div id="content" class="no-bottom no-top">
  ...
  <section class="no-top no-bottom jarallax vertical-center">
    <video :key="src" :width="width" autoplay>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            ...
            <p class="lead">
              Lorem ipsum enim dolor ea anim reprehenderit laboris aliquip sed dolore.
            </p>
        ...
        <div class="col-lg-4">
          <div class="de-room">
            <div class="d-image">
              ...
              <div class="d-details">
                <span class="d-meta-1">
                  <img src="@/assets/images/ui/user.svg" alt="" />2 Guests
                </span>
                <span class="d-meta-2">
                  <img src="@/assets/images/ui/floorplan.svg" alt="" />30 ft
                </span>
              </div>
              <a href="02-room-single.html">
                <img src="@/assets/images/room/1.jpg" class="img-fluid" alt="" />
                <img src="@/assets/images/room/1-alt.jpg" class="d-img-hover img-fluid" alt="" />
              </a>
            </div>
            ...
            <div class="d-text">
              <h3>Standard Room</h3>
              <p>
                Most hotels and major hospitality companies have set industry standards
                to classify hotel types. An upscale full-service hotel facility offers
                luxury...
              </p>
          ...
          <div class="de-room">
            <div class="d-image">
              ...
              <div class="d-details">
                ...
                <span class="d-meta-2">
                  <img src="@/assets/images/ui/floorplan.svg" alt="" />35 ft
                </span>
              </div>
              <a href="02-room-single.html">
          ...
          <div class="de-room">
            <div class="d-image">
              ...
              <div class="d-details">
                ...
                <span class="d-meta-2">
                  <img src="@/assets/images/ui/floorplan.svg" alt="" />40 ft
                </span>
              </div>
              <a href="02-room-single.html">
                <img src="@/assets/images/room/3.jpg" class="img-fluid" alt="" />
                <img src="@/assets/images/room/3-alt.jpg" class="d-img-hover img-fluid" alt="" />
              </a>
            </div>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-3 col-6">
          ...
          <img src="@/assets/images/misc/1.jpg" alt="" class="img-responsive wow fadeInUp" data-wow-duration="1s" />
        </div>

        <div class="col-lg-3 col-6">
          <img src="@/assets/images/misc/2.jpg" alt="" class="img-responsive wow fadeInUp" data-wow-duration="1.5s" />
        </div>

        <div class="col-lg-6 wow fadeIn">
          <div class="padding20">
            <h2 class="title mb10">
              The Luxury Experience<br />You'll Remember
              <span class="small-border"></span>
            </h2>
          ...
          <div id="testimonial-carousel-single" class="owl-carousel owl-theme wow fadeInUp">
            <blockquote class="testimonial-big">
              <span class="d-testi">The rooms were clean, very comfortable, and the staff was amazing. They
                ...
                this hotel for anyone visiting downtown</span>
              <span class="name">Benedict Mervine, Customer</span>
            </blockquote>

            <blockquote class="testimonial-big">
              <span class="d-testi">They were extremely accommodating and allowed us to check in early at
                like 10am. We got to hotel super early and I didn’t wanna wait. So this
                was a big plus. The sevice was exceptional as well. Would definitely
                send a friend there.</span>
            ...
            <blockquote class="testimonial-big">
              <span class="d-testi">I had a wonderful experience at the hotel. Every staff member I
                encountered, from the valet to the check- in to the cleaning staff were
                delightful and eager to help! Thank you! Will recommend to my
                colleagues!</span>
